// ===== BEATS DATA =====
const beatsData = [
    { id: 1, title: 'Midnight Vibes', artist: 'SoundLab Studios', genre: 'trap', price: 29, icon: '🎹' },
    { id: 2, title: 'Reggaeton Flow', artist: 'Latino Beats', genre: 'reggaeton', price: 29, icon: '🥁' },
    { id: 3, title: 'Hip-Hop Thunder', artist: 'Street Beats', genre: 'hip-hop', price: 39, icon: '🎙️' },
    { id: 4, title: 'R&B Smooth', artist: 'Urban Sounds', genre: 'r-b', price: 49, icon: '🎸' },
    { id: 5, title: 'Trap Energy', artist: 'SoundLab Studios', genre: 'trap', price: 29, icon: '💿' },
    { id: 6, title: 'Reggaeton Heat', artist: 'Latino Beats', genre: 'reggaeton', price: 29, icon: '🎵' },
    { id: 7, title: 'Hip-Hop Classic', artist: 'Street Beats', genre: 'hip-hop', price: 39, icon: '🎧' },
    { id: 8, title: 'R&B Passion', artist: 'Urban Sounds', genre: 'r-b', price: 49, icon: '🎼' },
];
...
function renderBeats(filter = 'todos', search = '') {
    ...
    beatsData
        ...
        .forEach(beat => {
            ...
            beatCard.innerHTML = `
                <div class="beat-card-image">${beat.icon}</div>
